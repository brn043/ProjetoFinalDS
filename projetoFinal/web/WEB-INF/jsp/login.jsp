<%-- 
    Document   : login
    Created on : 30/04/2024, 14:11:59
    Author     : Senai
--%>
        ...
        <div class="main-container">
            ...
            <div id="signin-container">
                ...
                <form action="./signin" method="get">
                    ...
                    <p>Senha: </p>
                    <input type="password" name="inPassword" id="inPassword" placeholder="Digite aqui" required><br>
                    <h6>Não possui uma conta? <button type="button" id="registerBtn">Registre-se</button></h6><br>
                    <button type="submit" name="signin" id="btn_signin">ENTRAR</button>
                </form>
            </div>
            <div id="signup-container">
                <h1>REGISTRE-SE</h1>
                <form action="./signup" method="post" name="frm_signin">
                    <p>Nome: </p>
                    ...
                    <input type="password" name="inPassword" id="inPassword" placeholder="Digite aqui" required><br>
                    <p>Cpf: </p>
                    <input type="number" name="inCpf" id="inCpf" placeholder="Digite aqui" required><br>
                    <p>Telefone: </p>
                    <input type="tel" name="inTelefone" id="inTelefone" placeholder="Digite aqui" required><br>
